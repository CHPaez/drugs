...
use App\Http\Controllers\Administracion\ModulosController;
    ...
    Route::module('Administracion de usuarios', function () {
        ...
        //Administracion de usuarios
        Route::module('Reportes', function () {
            Route::submodule('Administar reportes', function () {
                Route::resource('reportes', App\Http\Controllers\Reportes\reportesController::class);
                Route::post('reportes/selectores', [App\Http\Controllers\Reportes\reportesController::class, 'selectores'])->name('reportes.selectores.show');
            });
        });
